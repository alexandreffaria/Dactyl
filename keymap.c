...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_LOWER] = LAYOUT_5x6(
        ...
        _______,KC_HOME,KC_PGUP,KC_PGDN,KC_DQUO ,KC_LBRC,                       KC_RBRC , KC_P4 , KC_P5 , KC_P6 ,KC_PENT,KC_PIPE,
        _______,_______,_______,_______,KC_QUOT,KC_LPRN,                        KC_RPRN, KC_P1 , KC_P2 , KC_P3 ,KC_PENT ,KC_UNDS,
